...
- **Open source.** L'intero stack — dialogo, voce, dati, portale — usa componenti a licenza aperta e permissiva. **Eccezione al principio «permissiva», documentata e approvata dalla Direzione (2026-07-28):** il motore di **sintesi vocale** ha licenza **copyleft forte (GPL-3.0)**, non permissiva. È ammesso perché resta open-source, gratuito e locale (i vincoli «open source», «budget nullo» e «locale/on-premise» restano pienamente soddisfatti) e perché il pilota gira **on-premise senza distribuzione a terzi**: gli obblighi copyleft della GPL si attivano sulla distribuzione, che qui non avviene. **Da rivalutare** se il software venisse distribuito all'esterno o usato commercialmente. Il resto dello stack resta open source e **in prevalenza permissivo** (l'unico altro scostamento è la libreria di accesso al database, a copyleft *debole*/LGPL, già ammessa in precedenza); il dettaglio tecnico è in `STATO_TECNICO.md`.
